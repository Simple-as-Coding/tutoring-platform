...
import pl.simpleascoding.tutoringplatform.advertisement.AdvertisementCategory;

import javax.validation.constraints.NotNull;
import java.math.BigDecimal;

public record CreateAdvertisement(@NotNull(message = "Category could not be null") AdvertisementCategory category,
