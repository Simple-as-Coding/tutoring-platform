 ...
 * @param passwordConfirmed   Confirmation of the new user password
 */
@Immutable
public record ChangeUserPasswordDTO(String oldPassword, String newPassword, String passwordConfirmed) {
}
