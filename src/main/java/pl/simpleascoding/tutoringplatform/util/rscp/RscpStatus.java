...
/**
 * Enumeration of RSCP status codes.<br>
 * RSCP status codes have corresponding values for HTTP status codes.
 *
 * <p>The RSCP status code series can be retrieved via {@link #series()}.
 *
 * @see Series
...
public enum RscpStatus {
     ...
     * @deprecated in favor of {@link #FOUND} which will be returned from {@code RscpStatus.valueOf(302)}
     */
    @Deprecated MOVED_TEMPORARILY(302, Series.REDIRECTION, "Moved Temporarily"),
    /**
     * {@code 303 See Other}.
     *
     ...
     */
    @Deprecated USE_PROXY(305, Series.REDIRECTION, "Use Proxy"),
    /**
     ...
     * returned from {@code RscpStatus.valueOf(413)}
     */
    @Deprecated REQUEST_ENTITY_TOO_LARGE(413, Series.CLIENT_ERROR, "Request Entity Too Large"),
    /**
     ...
     * @deprecated in favor of {@link #URI_TOO_LONG} which will be returned from {@code RscpStatus.valueOf(414)}
     */
    @Deprecated REQUEST_URI_TOO_LONG(414, Series.CLIENT_ERROR, "Request-URI Too Long"),
    /**
     ...
     */
    @Deprecated INSUFFICIENT_SPACE_ON_RESOURCE(419, Series.CLIENT_ERROR, "Insufficient Space On Resource"),
    /**
     * @deprecated See
     * <a href="https://tools.ietf.org/rfcdiff?difftype=--hwdiff&amp;url2=draft-ietf-webdav-protocol-06.txt">
     * WebDAV Draft Changes</a>
     */
    @Deprecated METHOD_FAILURE(420, Series.CLIENT_ERROR, "Method Failure"),
    /**
     * @deprecated See <a href="https://tools.ietf.org/rfcdiff?difftype=--hwdiff&amp;url2=draft-ietf-webdav-protocol-06.txt">
     * WebDAV Draft Changes</a>
     */
    @Deprecated DESTINATION_LOCKED(421, Series.CLIENT_ERROR, "Destination Locked"),
    /**
    ...
    private static final RscpStatus[] VALUES;
    ...
    RscpStatus(int value, Series series, String reasonPhrase) {
        this.value = value;
        this.series = series;
    ...
    /**
     * Return the {@code RscpStatus} enum constant with the specified numeric value.
     *
     * @param statusCode the numeric value of the enum to be returned
     * @return the enum constant with the specified numeric value
     * @throws IllegalArgumentException if this enum has no constant for the specified numeric value
     */
    public static RscpStatus valueOf(int statusCode) {
        RscpStatus status = resolve(statusCode);
        if (status == null) {
    ...
    /**
     * Resolve the given status code to an {@code RscpStatus}, if possible.
     *
     * @param statusCode the HTTP status code (potentially non-standard)
     * @return the corresponding {@code RscpStatus}, or {@code null} if not found
     * @since 5.0
     */
    @Nullable
    public static RscpStatus resolve(int statusCode) {
        // Use cached VALUES instead of values() to prevent array allocation.
        for (RscpStatus status : VALUES) {
     ...
     * <p>Retrievable via {@link RscpStatus#series()}.
     */
    public enum Series {
        ...
        /**
         * Return the {@code Series} enum constant for the supplied {@code RscpStatus}.
         *
         * @param status a standard HTTP status enum constant
         * @return the {@code Series} enum constant for the supplied {@code RscpStatus}
         * @deprecated as of 5.3, in favor of invoking {@link RscpStatus#series()} directly
         */
        @Deprecated
        public static Series valueOf(RscpStatus status) {
        ...
        /**
         * Resolve the given status code to an {@code RscpStatus.Series}, if possible.
         *
         * @param statusCode the HTTP status code (potentially non-standard)
